...
public class LoginProfilePageTest extends BaseSuper {
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the Profile  button is Working for the Login user or not ")
...
//        profilePage=new ProfilePage(driver);
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the Flight Status link  is Display for the Login user or not ")
    ...
    @Description("Verify Flight Status Link enabled for  Login user ")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Login User should be able to see the Flight Status Link")
    ...
    @Description("Verify Flight Status Link is clickable for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the Flight Status Link is Clickable for the Login user or not ")
...
//        welcomePage.clickLoginAsQuest();
    ...
    @Description("Verify HelpAndFAQ Link enabled for  Login user ")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Login User should be able to see the HelpAndFAQ Link")
    ...
    @Description("Verify HelpAndFAQS Link is clickable for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the HelpAndFAQs Link is Clickable for the Login user or not ")
    ...
    @Description("Verify ContactUs Link enabled for  Login user ")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Login User should be able to see the ContactUs Link")
    ...
    @Description("Verify ContactUs Link is clickable for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the ContactUs Link is Clickable for the Login user or not ")
    ...
    @Description("Verify My Nominees button  is Display for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the My Nominees link  is Display for the Login user or not ")
    ...
    @Description("Verify My NomineesLink enabled for  Login user ")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Login User should be able to see the My Nominees Link")
    ...
    @Description("Verify My Nominees Link is clickable for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the My Nominees Link is Clickable for the Login user or not ")
    ...
    @Test(priority = 25, description = "TC_25 - Verify Whether Login User can  Add Nominees Details for the Login user or not ")
    @Description("Verify User can add Nominees Details ")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Add Nominees Details for the Login user or not ")
    ...
    @Description("Verify TermsAndConditions button  is Display for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Verify whether the TermsAndConditions link  is Display for the Login user or not ")
    ...
    @Description("Verify Terms and Conditions Link enabled for  Login user ")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("ProfilePage")
    @Story("Login User should be able to see the Terms and Conditions  Link")
