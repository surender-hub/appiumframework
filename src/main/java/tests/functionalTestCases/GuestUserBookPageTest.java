...
public class GuestUserBookPageTest extends BaseSuper {
    ...
    @Description("Verify Leisure button is displayed for the guest user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("BookPage")
    @Story("Verify whether the Leisure button is displayed for the Guest user or not ")
    ...
    @Description("Verify Work Radio button is displayed for the guest user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("BookPage")
    @Story("Verify whether the Work Radio button is displayed for the Guest user or not ")
    ...
    @Description("Verify Medical Radio button is displayed for the guest user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("BookPage")
    @Story("Verify whether the Medical Radio button is displayed for the Guest user or not ")
    ...
    @Description("Verify RoundTrip Radio button is displayed for the guest user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("BookPage")
    @Story("Verify whether the RoundTrip Radio button is displayed for the Guest user or not ")
...
//    }
    ...
    @Description("Verify Return button is clickable for the guest user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("BookPage")
