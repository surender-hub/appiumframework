...
public class LoginUserBookPageTest extends BaseTestLoginUser {
...
//    }
    ...
    @Description("Verify  Leisure  button is display for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("bookPage")
    @Story("Verify whether the Leisure  button is display for the Login user or not ")
    ...
    @Description("Verify Work Radio button is display for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("bookPage")
    @Story("Verify whether the Work Radio  button is display for the Login user or not ")
    ...
    @Description("Verify Medical Radio button is display for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("bookPage")
    @Story("Verify whether the Medical Radio  button is display for the Login user or not ")
    ...
    @Description("Verify RoundCity radio button is clickable for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("bookPage")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Feature("bookPage")
    @Story("Verify whether the RoundTrip Radio  button is display for the Login user or not ")
...
//    @Test(priority = 1, groups = {"smoke","regression"}, description = "TC_001 - Verify the  Quest User Link is Displaying or not ")
//    @Description("Verify Quest User Link is Displaying for the Login user")
//    @Severity(SeverityLevel.CRITICAL)
//    @Feature("bookPage")
//    @Story("Verify whether the Quest User Link is Displaying for the Login user or not ")
...
//    @Test(priority = 1, groups = {"smoke","regression"}, description = "TC_0032 - Verify the  Quest User Link is Working or not ")
//    @Description("Verify Quest User Link is Working for the Login user")
//    @Severity(SeverityLevel.CRITICAL)
//    @Feature("bookPage")
//    @Story("Verify whether the Quest User Link is Working for the Login user or not ")
...
//    @Severity(SeverityLevel.CRITICAL)
//    @Feature("bookPage")
//    @Story("Verify whether the Close Passenger Selection  button is Display for the Login user or not ")
...
//    }
    ...
    @Test(priority = 46, groups = {"smoke","regression"}, description = "TC_45 - Verify the Going To  Link is Working or not ")
    @Description("Verify flying from  Link is Working for the Login user")
    @Severity(SeverityLevel.CRITICAL)
    @Feature("bookPage")
    ...
    @Test(priority = 47, groups = {"smoke","regression"}, description = "TC_46 - Verify the Add Nominee Link is Displaying or not ")
    ...
    @Test(priority = 48, groups = {"smoke","regression"}, description = "TC_48 - Verify the Add Nominee Link is Working or not ")
