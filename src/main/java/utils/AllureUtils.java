...
public class AllureUtils {
    ...
    public static class LoginUserIndigoEndToEndFlowTest extends BaseTestLoginUser {
        ...
        public void generatePnrSelectSeatOneWay() throws InterruptedException {
           ...
           // welcomePage.clickLogin();
            ...
            searchPage.bookingNextButton();
            searchPage.enterUserDetails("Shubham", "Jain", "02/04/1953", "6474344463", "Indisddftusneo@gmail.com");
            LogUtils.info("Enter User Details");
            seatPage.selectSeat();
